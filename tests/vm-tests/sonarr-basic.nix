        ...
        sonarr = {
          ...
          config = {
            hostConfig = {
              port = 8989;
              username = "admin";
              password = {_secret = toString (pkgs.writeText "sonarr-password" "testpassword123");};
            };
            apiKey = {_secret = toString (pkgs.writeText "sonarr-apikey" "0123456789abcdef0123456789abcdef");};
            delayProfiles = [
              {
                enableUsenet = true;
                enableTorrent = true;
