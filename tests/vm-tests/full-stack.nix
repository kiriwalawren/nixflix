        ...
        sonarr-anime = {
          ...
          config = {
            hostConfig = {
              port = 8990;
              username = "admin";
              password = {_secret = toString (pkgs.writeText "sonarr-anime-password" "testpass");};
            };
            apiKey = {_secret = toString (pkgs.writeText "sonarr-anime-apikey" "sonarr222222222222222222222222222");};
          };
        };
